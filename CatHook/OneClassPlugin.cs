...
namespace CatHook
{
    ...
    {
        private string _access = "76561198840787587@steam";
        ...
        {
            _access = Config.GetString("cathook_access", "76561198840787587@steam", "Те, кто смогут заспавнить крюк командой .hook owner");
